...
function aplicarDescuentoYMostrar(total) {
    let tieneDescuento = total > 100;
    let totalFinal = tieneDescuento ? total * 0.85 : total;
    alert(
        "Total a pagar: $" + totalFinal.toFixed(2) +
        (tieneDescuento ? " (con 15% de descuento)" : " (sin descuento)")
    );
}
